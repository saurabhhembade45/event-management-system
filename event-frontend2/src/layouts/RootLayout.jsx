...
const RootLayout = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background relative selection:bg-indigo-500/30">
      ...
      <div className="flex-1 flex flex-col relative overflow-hidden z-10 min-w-0">
        <Navbar onMenuToggle={() => setMobileMenuOpen(!mobileMenuOpen)} />
        <main className="flex-1 overflow-y-auto px-3 sm:px-6 pb-8 md:px-8 custom-scrollbar">
          <Outlet />
        </main>
      </div>
    </div>
